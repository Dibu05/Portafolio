...
const Portafolio_Data = [
  ...
  },
  {
    ...
    description: "Proyecto en el que trabajo con otros dev para la empresa NIPPY basado en el desarrollo de una aplicación Mobile para el servicio de delivery que incluye: registro, login, perfil, localización en mapa, entre otras.",
    likes: 1020,
